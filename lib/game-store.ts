...
export interface NPC {
  ...
  dialogues: {
    first: string      // 첫 만남
    low: string[]      // 호감 0~29, 4 variants
    mid: string[]      // 호감 30~59, 4 variants
    high: string[]     // 호감 60~99, 4 variants
    max: string[]      // 호감 100, 4 variants
...
export const NPCS: NPC[] = [
  // ── 여성 NPC ─────────────────────────────────────────────────
  {
    ...
    dialogues: {
      ...
      low: [
        "용무가 있으면 말하도록. 나는 바쁜 사람이야.",
        "...왕녀에게 그렇게 쉽게 말을 거는 건가. 예의는 있군.",
        "뭔가 볼일이 있어? 시간 낭비는 질색이야.",
        "왕녀인 내게 감히 말을 걸다니. 그 용기는 인정하지.",
      ],
      mid: [
        "...최근 네가 눈에 띄더군. 뭔가 다른 구석이 있어.",
        "솔직히 말하면, 너와 이야기하는 건 그리 나쁘지 않아. 기대 이상이야.",
        "평민 출신이라고 들었는데... 처신이 꽤 반듯하군.",
        "왕녀로서 이런 말은 잘 하지 않는데... 오늘 이야기는 흥미로웠어.",
      ],
      high: [
        "{플레이어}, 솔직히 말할게. 이런 감정은 처음이야. 네 옆에 있으면... 조금 편해.",
        "왕궁 안에서 나를 이름으로 불러준 건 네가 처음이야. 이상하게 싫지가 않더라.",
        "나는 항상 혼자였어. 왕녀이기 때문에... 그런데 네 옆에선 그런 생각이 들지 않아.",
        "...오늘 정원 산책, 나쁘지 않았어. 다음에도 함께해줄 수 있을까.",
      ],
      max: [
        "왕녀로서가 아닌 그냥 나로서 말하는 거야. {플레이어}, 나는 네가 좋아.",
        "평생 감정을 숨기며 살았는데... 더 이상 숨기고 싶지 않아. 나는 너를 사랑해, {플레이어}.",
        "어떤 자리에 있어도, 어떤 상황이어도... 내 마음속엔 언제나 네가 있을 거야.",
        "왕녀의 자리가 아무리 외로워도, 네가 있다면 견딜 수 있을 것 같아. {플레이어}, 곁에 있어줘.",
      ],
      gift_low: "...흠. 성의는 인정하지.",
  ...
  },
  {
    ...
    dialogues: {
      ...
      low: [
        "훈련에는 집중하도록. 잡담은 필요 없어.",
        "교관에게 말을 걸다니. 그 담력은 인정하지.",
        "아직 실력이 부족해. 말 걸 시간에 훈련이나 해.",
        "나는 결과로만 말한다. 실력을 보여줘.",
      ],
      mid: [
        "...너 꽤 성장했군. 합격이다.",
        "솔직히 처음엔 기대 안 했어. 근데 틀렸어. 너, 생각보다 대단하더라.",
        "실력으로 인정받고 싶다면, 지금처럼만 해. 충분해.",
        "가끔 네 훈련 방식을 보면서 나도 배우는 게 있어. 드문 일이야.",
      ],
      high: [
        "{플레이어}, 교관으로서가 아니라 개인적으로 말하는 거야. 넌 내가 만난 제자 중 가장 성실해.",
        "이런 말은 하기 싫었는데... 네가 훈련장에 없으면 뭔가 허전하더라.",
        "...나, 사실 너한테 특별히 신경 쓰고 있었어. 교관이라서가 아니라.",
        "같이 훈련하면서, 너 덕분에 나도 많이 배웠어. 이상한 일이지.",
      ],
      max: [
        "이런 말은 처음 하는데... 훈련 이후에 같이 밥이라도 먹을래?",
        "교관과 제자로 끝내기엔... 내 마음이 그걸 허락하지 않아.",
        "{플레이어}. 나는 검을 삶으로 알았어. 근데 네 옆에선 다른 게 삶이 될 수 있겠다는 생각이 들어.",
        "긴 말은 싫어하니까 짧게 할게. 나는 너를 사랑해, {플레이어}.",
      ],
  ...
  },
  {
    ...
    dialogues: {
      ...
      low: [
        "{플레이어}! 오늘도 잘 지냈어? 나 새로운 마법 배웠는데 볼래?",
        "어! 오늘 도서관에서 재밌는 책 발견했어! 마법에 관한 거야!",
        "같이 연구해볼 마법 없어? 나 실험 파트너 항상 구하고 있는데!",
        "오늘 수업 어땠어? 나는 선생님 말씀이 계속 생각나!",
      ],
      mid: [
        "{플레이어}랑 이야기하면 항상 즐거워. 왠지 같이 있으면 마음이 편해.",
        "있잖아, 나 최근에 생각한 건데... 마법보다 재밌는 게 생긴 것 같아. 뭔지 알아?",
        "어제 별 보면서 {플레이어} 생각했어. 왜인지는 모르겠지만.",
        "솔직히 말하면, 너랑 같이 있으면 마법 연구도 더 잘 돼. 신기하지?",
      ],
      high: [
        "있잖아, {플레이어}... 사실 좋아하는 사람 생겼어. 아직 말 못 하겠지만.",
        "요즘 자꾸 네 생각이 나. 실험하다가도, 책 읽다가도... 어떡하지?",
        "너한테 특별한 마법을 보여주고 싶어서 연습했는데... 보여줘도 돼?",
        "마법사로서 평생 연구만 하며 살 줄 알았는데... 네가 그 계획을 조금 바꿨어.",
      ],
      max: [
        "{플레이어}한테만 말할게. 사실 그 좋아하는 사람... 너야. 바보같지?",
        "더 이상 숨기기 싫어. 나, {플레이어} 좋아해. 오래 전부터.",
        "마법사의 심장은 논리적이어야 한대. 근데 내 심장은 네 앞에선 영 논리가 없어.",
        "세라 선생님이 되려 했는데... 네 앞에선 그냥 세라야. 나, 너 좋아해.",
      ],
  ...
  },
  {
    ...
    dialogues: {
      ...
      low: [
        "어이! 오늘도 어때? 나는 상점가에서 알바 뛰느라 바빠 죽겠어.",
        "뭐 필요한 거 있어? 싸게 구해줄 수 있어, 나 아는 사람 많거든.",
        "요즘 경기가 안 좋아서... 아, 그런 얘기 말고 다른 거 얘기할까?",
        "같이 시장 갈래? 거기 새로 생긴 가게 궁금하던데.",
      ],
      mid: [
        "{플레이어}는 진짜 가끔 놀래키더라. 평범한 것 같아도 특별한 구석이 있어.",
        "솔직히 처음엔 그냥 지인이라고 생각했는데... 점점 중요해지고 있어.",
        "아 진짜, 왜 네 얘기만 들으면 기분이 좋아지냐. 불공평해.",
        "너랑 있으면 장사 걱정을 잊어. 그게 얼마나 대단한 일인 줄 알아?",
      ],
      high: [
        "솔직히 말하면... {플레이어} 옆에 있는 게 제일 편해. 이거 고백이라고 받아들여도 돼.",
        "장사꾼은 이익 따져야 한다고 배웠는데... 너 앞에선 계산이 안 돼.",
        "내가 살면서 이런 감정은 처음이야. 좀 당황스럽기도 하고.",
        "알아? 요즘 상점 갈 때 네가 떠올라. 이 물건 {플레이어}가 좋아하겠다, 이러면서.",
      ],
      max: [
        "에이, 숨길 필요 없잖아. 나 {플레이어} 좋아해. 거절할 거야?",
        "결론부터 말하는 게 상인 스타일이야. 나 너 좋아해. 이제 어떡할 거야?",
        "네가 없는 하루는 장사가 잘 돼도 허전하더라. 이거 꽤 심각하지 않아?",
        "딱 한 번만 솔직하게 말할게. 평생 네 옆에 있고 싶어. 해줄 수 있어?",
      ],
  ...
  // ── 남성 NPC ─────────────────────────────────────────────────
  {
    ...
    dialogues: {
      ...
      low: [
        "{플레이어}. 기사의 길은 쉽지 않아. 하지만 네겐 그 자질이 보여.",
        "왕국의 기사로서 너를 지켜보고 있다. 실망시키지 마라.",
        "강함이란 힘만이 아니야. 도덕과 의지가 함께해야 해.",
        "오늘 훈련은 어땠어? 기사의 길은 끊임없는 수련이야.",
      ],
      mid: [
        "솔직히 말하면... 너와 이야기하는 시간이 하루 중 가장 즐거워.",
        "처음엔 그냥 관찰 대상이었어. 근데 어느 순간부터 달라졌어.",
        "기사는 감정에 흔들리지 않아야 한다고 배웠어. 근데 너 앞에선 그게 잘 안 돼.",
        "왕국에서 내 고민을 들어줄 사람을 찾기 어려웠어. 근데 너와 이야기하면 달라.",
      ],
      high: [
        "{플레이어}, 기사로서 맹세할게. 너를 지키겠어. 그 이상의 의미도 담아서.",
        "나는 의무를 다하는 삶을 살아왔어. 근데 네 옆에선 다른 무언가를 원하게 돼.",
        "왕자로서의 삶은 고독해. 하지만 너와 함께라면 그 고독도 견딜 수 있을 것 같아.",
        "이런 말을 하게 될 줄 몰랐어. 하지만 솔직히 말할게... 너는 내게 특별한 사람이야.",
      ],
      max: [
        "왕자로서의 의무와 내 마음 사이에서 고민했어. 하지만 답은 하나야. {플레이어}, 나와 함께해 줄래?",
        "기사의 맹세보다 더 강한 마음으로 말할게. 나는 너를 사랑해, {플레이어}.",
        "평생 의무로만 살아왔는데... 처음으로 내가 원하는 것을 원해. 그게 바로 너야.",
        "검을 잡은 이 손으로, 네 손을 잡고 싶어. {플레이어}, 내 곁에 있어줘.",
      ],
      gift_low: "성의는 받아들이겠어.",
  ...
  },
  {
    ...
    dialogues: {
      ...
      low: [
        "거래는 항상 이익을 따져야 해. 감정 따위에 휘둘리지 말고.",
        "...재미있는 눈빛이군. 두려움이 없는 건지, 아니면 어리석은 건지.",
        "나와 거래를 원한다면 대가를 치를 준비가 되어 있어야 해.",
        "어둠을 두려워하는 자는 나와 상대하기 어려워. 넌 어떤가.",
      ],
      mid: [
        "{플레이어}, 넌 나와 비슷해. 세상의 밝은 면만 보는 척하는 바보들과 달리.",
        "나 같은 자와 함께하는 게 두렵지 않아? ...그 담력이 마음에 들어.",
        "어둠 속에서도 신념을 잃지 않는다면... 그건 진짜 강함이야. 넌 그게 있어.",
        "솔직히 오래간만이야. 내 말에 겁내지 않는 사람이.",
      ],
      high: [
        "이런 감정은 거래에 방해가 되는데... 네 앞에선 계산이 안 돼.",
        "어둠 속에 너무 오래 있었나봐. 네 존재가 자꾸 신경 쓰여.",
        "...내가 이런 말을 하게 될 줄은 몰랐어. 하지만 너를 해하고 싶지 않아.",
        "거래상이라는 껍데기 아래에... 진짜 나를 보는 건 네가 처음이야.",
      ],
      max: [
        "어둠 속에서 오래 살았어. 따뜻한 게 뭔지 잊었는데... {플레이어}, 넌 나를 바꿔.",
        "이건 거래가 아니야. 대가 없이 말하는 거야. 나는 너를 사랑해.",
        "어둠을 함께 걸을 사람이 필요해. 그 사람이 너였으면 해, {플레이어}.",
        "평생 혼자였어. 근데 이젠... 네가 없으면 어둠이 더 어두워. 그게 무슨 의미인지 알아.",
      ],
      gift_low: "흥미롭군. 가져가지.",
  ...
  },
  {
    ...
    dialogues: {
      ...
      low: [
        "어, {플레이어}? 오늘도 열심히 하는군. 나는 그냥 나무 아래서 쉬려고.",
        "별일 없어? 나는 오늘도 별일 없었어. 그게 제일 좋아.",
        "요즘 새 곡 구상 중인데... 영감이 잘 안 와. 뭐 좋은 거 없어?",
        "귀족 생활도 생각보다 따분해. 너는 어때?",
      ],
      mid: [
        "{플레이어}랑 이야기하면 심심하지가 않아. 이거 드물거든, 나한테.",
        "사실 처음엔 그냥 지나가는 사람이라 생각했어. 근데 왜인지 자꾸 찾게 돼.",
        "게으른 성격이라 아무도 나한테 오래 관심 안 갖는데... 넌 달라.",
        "오늘 나무 아래서 쉬면서 네 생각을 했어. 이상하지?",
      ],
      high: [
        "사실 너한테만 보여주고 싶은 게 있어. 내가 작곡한 거야. 들어볼래?",
        "귀족이고 음악가고 다 필요 없어. 너 앞에선 그냥 레온이고 싶어.",
        "내 음악을 진심으로 들어준 건 네가 처음이야. 그게... 많이 좋았어.",
        "솔직히 말하면, 요즘 창작 의욕이 넘쳐. 네 덕분인 것 같아.",
      ],
      max: [
        "{플레이어}... 솔직히 말할게. 이 음악, 처음부터 끝까지 네 생각 하면서 만들었어.",
        "느긋하게 살아왔는데... 처음으로 서두르고 싶은 게 생겼어. 그게 너야.",
        "귀족의 체면은 여기 두고 가도 돼. {플레이어}, 나는 너를 사랑해.",
        "평생 누군가를 위해 음악을 쓴 적이 없었어. 근데 이제 모든 음악이 네 것 같아.",
      ],
  ...
  },
  {
    ...
    dialogues: {
      ...
      low: [
        "{플레이어}! 오늘 훈련 엄청 힘들었다. 근데 포기 안 했어! 파이팅!",
        "야, 저번에 배운 기술 써봤어? 나는 완전 성공했어!",
        "평민이라서 불리한 거 많은데... 그래도 노력하면 되잖아. 그렇게 생각하지 않아?",
        "오늘 밥 같이 먹을래? 나 삶은 계란 두 개 있어!",
      ],
      mid: [
        "있잖아, {플레이어}. 나 힘들 때 네가 옆에 있어줘서 진짜 힘이 됐어.",
        "솔직히 아카데미 오면서 친구 사귀기 어렵다고 생각했어. 근데 너 만나서 다행이야.",
        "너랑 훈련하면 더 열심히 하게 돼. 왜인지 알아? 지고 싶지 않아서야!",
        "{플레이어}는 좋은 사람이야. 진짜로. 나 사람 보는 눈은 있거든.",
      ],
      high: [
        "{플레이어}... 내가 평민이라서 이런 말 하기 어려운데. 그래도 말하고 싶어.",
        "매일 네 생각이 나. 훈련할 때도, 밥 먹을 때도... 이거 좋아하는 거 맞지?",
        "나 같은 평민이 이런 마음을 가져도 되는지 모르겠는데... 솔직히 네가 좋아.",
        "한 가지만 물어봐도 돼? 나... 너한테 특별한 사람이야?",
      ],
      max: [
        "나 {플레이어} 좋아해! 귀족이든 평민이든 상관없잖아! 같이 해줄래?!",
        "오래 망설였어. 근데 더 이상은 못 참겠어. {플레이어}, 나 진심이야!",
        "평민이어서 부끄러운 적은 많았어. 근데 내 마음만큼은 누구한테도 안 지거든!",
        "세상에서 제일 좋아하는 거 두 가지가 생겼어. 훈련... 그리고 너야, {플레이어}.",
      ],
...
export const ENDINGS: Ending[] = [
  ...
  // ── 로맨스 엔딩 ────────────────────────────────────────────
  { id: "romance-liana", title: "왕녀와의 약속", description: "리아나 왕녀와 깊은 인연을 맺았다. 왕궁의 정원에서 두 사람은 영원을 약속했다. {플레이어}는 왕실의 귀빈으로 초대받아 새로운 삶을 시작한다.",
    type: "romance" as const,
    letter: {
      greeting: "아빠에게",
      paragraphs: [
        "아빠, 저 잘 지내고 있어요. 걱정하지 마세요. 요즘은 왕궁 정원을 산책하는 게 낙이에요. 리아나가 제일 좋아하는 곳이거든요.",
        "리아나는요, 시작에는 정말 차갑고 도도한 사람인 줌만 알았어요. 근데 알고 보면 누구보다 외롭고 따뜻한 사람이에요. 아빠도 만나보면 분명 좋아하실 거예요.",
        "왕궁에서의 생활이 아직 낙선로기도 하지만, 리아나가 옆에서 하나하나 알려줘요. 왕녀인데 이런 거 챙겨줘도 되냀고 물었더니 '내가 하고 싶어서 하는 거야'라고 했어요. 그 말이 너무 좋았어요.",
        "아빠가 열심히 키워주신 덕분에 이런 인연을 만난 수 있었다고 생각해요. 감사해요, 아빠. 건강하세요.",
      ],
      closing: "왕궁에서, {이름} 올림",
    },
  ...
  { id: "romance-erika", title: "교관과 제자, 그 너머", description: "에리카 교관과의 특별한 관계가 꽃피었다. 두 사람은 함께 왕국 최강의 전사 파트너가 되기로 했다.",
    ...
    letter: {
      greeting: "아빠에게",
      paragraphs: [
        "아빠, {이름}이에요. 에리카와 함께 왕국 최고의 전사 파트너로 활동하고 있어요. 매일 새벽 훈련부터 시작하는 바쁜 나날이지만, 신나요.",
        "에리카는요, 걉으로는 엄격하고 무서운 교관이에요. 근데 아침마다 제 먥3의 식사를 챙겨주고, 힘들어 보이면 먼저 알아채서 쉼라고 해줘요. 그런 사람이에요.",
        "처음에 아카데미에서 훈련받을 때는 정말 무서웠거든요. 그런데 지금은 그 사람이 있어서 어떤 싸움도 겁나지 않아요. 이상하죠?",
        "아빠 덕분에 포기 않는 법을 배웠어요. 그게 저를 에리카 앞에서도 당당하게 만들어준 것 같아요. 고마워요, 아빠.",
      ],
      closing: "훈련장에서, {이름} 올림",
    },
  ...
  { id: "romance-sera", title: "마법사의 봄", description: "세라와 함께하는 마법 연구는 세계 최고의 성과를 냈다. 두 사람의 마법이 공명할 때, 세계수조차 반응했다.",
    ...
    letter: {
      greeting: "아빠에게",
      paragraphs: [
        "아빠! 저 세라랑 마법 연구소 차렸어요! 작지만 우리만의 공간이 생겼어요. 매일 이것저것 실험하다가 폭발도 좌 내지만... 뒤 괴다어요!",
        "세라는 정말 신기한 사람이에요. 모든 것에 호기심이 넘치고, 절대 포기를 모라요. 그런 모습 보면서 저도 모르게 힘이 생겼요.",
        "마법이 공명할 때가 있어요. 서로의 마법이 딥 맞아 떨어지는 순간이요. 그때 세라가 웃으면서 '우리 궁합 완벽하다!'라고 하는데, 정말 그런 것 같아요.",
        "아빠가 가르쳐주신 성실함 덕분에 좋은 사람을 만났어요. 앞으로도 열심히 살게요!",
      ],
      closing: "연구소에서, {이름} 올림",
    },
  ...
  { id: "romance-mina", title: "상인과 모험가의 여행", description: "미나와 함께 왕국 곳곳을 여행하는 대상인이 되었다. 돈도 모험도 가득한, 둘만의 여행이 시작된다.",
    ...
    letter: {
      greeting: "아빠에게",
      paragraphs: [
        "아빠, 저 미나랑 왕국 이곳저곳 여행하고 있어요! 진짜 대상인이 다 딌어요. 어제는 항구 도시에서 희귀한 향신료를 엄청 싸게 구해서 세 배로 팔았어요.",
        "미나는요, 항상 웃고 있어요. 힘들어도 '뒤, 어떻게든 되갯지!'라고 해요. 그 낙천성이 시작엔 이해가 안 뤌는데, 이제는 제일 좋은 부분이 딌어요.",
        "장사하면서 싸울 때도 있고 의견이 다를 때도 있어요. 근데 신기하게 결론은 항상 같이 있는 방향으로 나와요. 저도 모르게 웃게 되더라고요.",
        "아빠가 힘들 때도 늘 웃어주셔서, 저도 그렇게 하는 법을 배운 것 같아요. 덕분에 미나를 이해할 수 있었어요. 감사해요.",
      ],
      closing: "여행 중에, {이름} 올림",
    },
  ...
  { id: "romance-kairen", title: "기사의 맹세", description: "카이렌과 함께 왕국의 수호자가 되었다. 두 사람은 서로의 검이 되어 세계의 평화를 지키겠다고 맹세했다.",
    ...
    letter: {
      greeting: "아빠에게",
      paragraphs: [
        "아빠, {이름}이에요. 요즘 카이렌이랑 왕국 순찰을 함께 다니고 있어요. 기사단 생활이 생각보다 바쁜데, 지치지 않아요.",
        "카이렌은 정의롭고 곣은 사람이에요. 타협을 모라서 가끈 답답할 때도 있지만, 그게 또 이 사람의 제일 믿음직한 부분이에요. 약자 앞에서는 절대 외면하지 않거든요.",
        "어느 날 카이렌이 그랐어요. '너를 지키는 게 의무가 아니라 바람이 뤌어.' 그 말을 듣고 한참 동안 아무 말도 못 했어요.",
        "아빠가 가르쳐주신 도덕과 용기 덕분에, 카이렌이 저를 동등한 사람으로 봐준 것 같아요. 그게 제일 자랑스러워요.",
      ],
      closing: "기사단 막사에서, {이름} 올림",
    },
  ...
  { id: "romance-darius", title: "어둠 속의 빛", description: "다리우스와 함께 어둠의 세계에 발을 들였다. 그러나 두 사람이 함께라면, 그 어둠도 따뜻하다.",
    ...
    letter: {
      greeting: "아빠에게",
      paragraphs: [
        "아빠, 걱정하실 것 같아서 편지 써요. 저 괴다요. 다리우스랑 함께 있어요.",
        "다리우스는... 어둠 속에서 오래 산 사람이에요. 시작엔 무서고 이해할 수 없었어요. 근데 그 사람도 따뜻함을 원하고 있었다는 걸 알았을 때, 모든 게 달라졌어요.",
        "이상하게 들릴 수 있는데, 그 사람 옆에서는 저도 더 강해지는 것 같아요. 어둠을 두려워하지 않으면서도, 빛을 잊지 않는 법을 배웠어요.",
        "아빠가 절 믿고 키워주신 것체럼, 저도 다리우스를 믿기로 했어요. 언젠가 꼼 인사드릴게요.",
      ],
      closing: "어딘가에서, {이름} 올림",
    },
    requirements: { romancedNpc: "darius", morality: { max: -5 } }, priority: 0, image: "🌑", difficulty: 4, category: "dark" as const },
  { id: "romance-leon", title: "귀족의 선율", description: "레온이 {플레이어}를 위해 작곡한 교향곳이 왕국 전역에 울려 퍼졌다. 두 사람의 이름은 예술의 역사에 함께 새겨졌다.",
    type: "romance" as const,
    letter: {
      greeting: "아빠에게",
      paragraphs: [
        "아빠! 저 레온이랑 잘 지내고 있어요. 요즘은 귀족 저택 정원에서 레온이 작곡하는 걸 옆에서 듣는 게 제일 좋은 시간이엔요.",
        "레온은 게으른 쫓하지만, 음악에 관해서라면 진지한 사람이에요. 새벽까지 작곡에 빠져 있다가 제가 깨우면 '어, 볌써 아침이야?'라고 해요. 그 모습이 너무 귀엽거든요.",
        "얼마 전에 레온이 저한테 바치는 교향곳을 완성했어요. 왕궁 연주회에서 심처음 연주됐는데, 저도 모르게 눈물이 났어요. 그게 제 이야기라는 걸 알아서요.",
        "아빠 덕분에 음악을 좋아하는 마음을 잊지 않았어요. 그래서 레온의 음악을 진심으로 들을 수 있었던 것 같아요. 고마워요.",
      ],
      closing: "레온의 저택에서, {이름} 올림",
    },
  ...
  { id: "romance-tom", title: "평민의 영웅", description: "톰과 함께, 귀족도 평민도 없는 진짜 실력의 세계를 만들어나가기로 했다. 두 사람의 우정과 사랑은 왕국 전설이 된다.",
    ...
    letter: {
      greeting: "아빠에게",
      paragraphs: [
        "아빠!! 저 톰이랑 엄청 잘 지내고 있어요! 요즘은 같이 마을 사람들 훈련 도와주는 일을 하고 있는데, 정말 보람차요!",
        "톰은요, 귀족도 평민도 없는 세상을 만들고 싶다고 해요. 시작엔 꿼같은 소리라고 생각했는데, 톰이 진심으로 그 꿼을 향해 달리는 걸 보면서 저도 그 꿼을 믿게 넌어요.",
        "힘들 때도 있어요. 평민 출신이라서 무시받을 때도요. 근데 톰이 항상 '우리가 보여주면 돼!'라고 해요. 그 에너지가 진짜 대단해요. 저도 자꼬 따라가게 돼요.",
        "아빠가 절 평민이든 귀족이든 상관없이 최선을 다하라고 가르쳐주셨쟓아요. 그 덕분에 톰과 같은 눈높이에서 만난 수 있었던 것 같아요.",
      ],
      closing: "마을에서, {이름} 올림",
    },
...
export const useGameStore = create<GameState>((set, get) => ({
  ...
  talkToNpc: (npcId) => {
    ...
    let dialogue = pick(npc.dialogues.low)
    ...
    if (!npcMet.includes(npcId)) {
      ...
      return
    } else if (affection >= 100) dialogue = pick(npc.dialogues.max)
    else if (affection >= 60)  dialogue = pick(npc.dialogues.high)
    else if (affection >= 30)  dialogue = pick(npc.dialogues.mid)
